...
class ChatPanel extends React.Component {
    ...
    loadUsers() {
        ...
        fetch('http://127.0.0.1:8000/chats/users', {
            method: 'POST',
            headers: {
    ...
    loadChats(el_id) {
        ...
        fetch('http://127.0.0.1:8000/chats/messages?rec_id=' + clicked_user_id, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                X_CSRF_TOKEN: tok,
    ...
    handleEve(e) {
        ...
        fetch('http://127.0.0.1:8000/chats/messages?message=' + msg + '&rec_id=' + activeUserId, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': tok,
            ...
            <div className="container">
                ...
                <div className="row no-gutters">
                            ...
                            <div className="card-body">
                                <ul id="user_list" className="user_list list-group">
                                    {this.state.user_list.map((number) =>
                                        <a href="@/Pages/Chats/ChatPanel#">
                                            <li id={"user_" + number.id} onClick={this.loadChats}
                    ...
                    <div className="col">
                        <div className="card">
                            <div
                                className="card-header">{isAnyUserActive ? this.state.active_user[0].name : 'no active'}</div>
                            <div className="card-body">
                            ...
                            <div className="card-footer">
                                ...
                                <input type="submit" className="btn btn-primary btn-sm" value="GO"
